...
public final class WallpaperUtils {
    ...
    static void saveWallpaperDimensions(int width, int height, Activity activity) {
        ...
        SharedPreferences sp = activity.getSharedPreferences(spKey, Context.MODE_PRIVATE);
    ...
    private static void suggestWallpaperDimensionPreK(
        ...
        SharedPreferences sp = activity.getSharedPreferences(
              WallpaperFiles.WALLPAPER_CROP_PREFERENCES_KEY, Context.MODE_PRIVATE);
